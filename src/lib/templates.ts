...
// ==========================================
// Final Bill निबेदन (अन्तिम बिल भुक्तानी)
// ==========================================
export function finalBillNibedanTemplate(profile: CompanyProfile | null, bid?: Partial<BidData>): string {
  const co = profile?.companyName || '[कम्पनीको नाम]';
  const addr = profile?.address || '[ठेगाना]';
  const rep = profile?.authorizedRepresentative || '[अधिकृत प्रतिनिधि]';
  const desig = shortDesignation(profile?.designation || '');
...
विषय: अन्तिम बिल (Final Bill) भुक्तानी सम्बन्धमा ।
...
सन्दर्भ:
  ...
  आयोजना: ${proj}
  ठेक्का सम्झौता मिति: [___________]
  कार्य सम्पन्न मिति: [___________]
  Substantial Completion Certificate मिति: [___________]

महोदय,

उपरोक्त सन्दर्भित ठेक्काको सम्पूर्ण कार्य सम्पन्न भई Engineer बाट Substantial Completion Certificate प्राप्त भइसकेको हुँदा अन्तिम बिल (Final Bill) भुक्तानीको लागि यो निवेदन पेश गर्दछु ।

═══════════════════════════════════════════════════
        अन्तिम बिल सारांश (Final Bill Summary)
═══════════════════════════════════════════════════

क्र.सं. │ विवरण                              │ रकम (रु.)
────────┼─────────────────────────────────────┼──────────────
  १    │ मूल ठेक्का रकम (Original Contract)  │ [___________]
  २    │ Variation Order रकम (+/-)           │ [___________]
  ३    │ Price Adjustment (यदि लागू)         │ [___________]
  ४    │ अन्तिम ठेक्का रकम (Final Contract)  │ [___________]
────────┼─────────────────────────────────────┼──────────────
  ५    │ कुल कार्य सम्पादन (Total Executed)  │ [___________]
  ६    │ अघिल्लो IPC सम्म भुक्तानी           │ [___________]
  ७    │ यस बिलमा दाबी रकम (5 - 6)          │ [___________]
────────┼─────────────────────────────────────┼──────────────
       │ कट्टी (Deductions):                 │
  ८    │   - Retention Money फिर्ता          │ (+) [________]
  ९    │   - Advance Recovery बाँकी          │ (-) [________]
  १०   │   - Liquidated Damages (यदि लागू)   │ (-) [________]
  ११   │   - अन्य कट्टी                     │ (-) [________]
────────┼─────────────────────────────────────┼──────────────
  १२   │ कुल भुक्तानीयोग्य रकम              │ [___________]
────────┴─────────────────────────────────────┴──────────────

═══════════════════════════════════════════════════
          Retention Money विवरण
═══════════════════════════════════════════════════

विवरण                              │ रकम (रु.)
────────────────────────────────────┼──────────────
कुल Retention कट्टी (५%)           │ [___________]
Substantial Completion मा ५०% फिर्ता│ [___________]
DLP पछि बाँकी ५०% फिर्ता          │ [___________]
────────────────────────────────────┴──────────────

संलग्न कागजातहरू:
  १. Final Measurement Book (सम्पूर्ण)
  २. Joint Measurement Sheets
  ३. As-Built Drawings
  ४. Substantial Completion Certificate
  ५. सम्पूर्ण Quality Test Reports
  ६. BOQ Item-wise Final Statement
  ७. Variation Order स्वीकृति पत्रहरू
  ८. Price Adjustment Calculation (यदि लागू)
  ९. Photographs (Before, During & After)
  १०. No Claim Certificate (ठेकेदारबाट)

अतः सार्वजनिक खरिद ऐन, २०६३ को दफा ४८ तथा FIDIC Clause 14.11 बमोजिम अन्तिम बिल भुक्तानी प्रक्रिया अगाडि बढाइदिनु हुन विनम्र अनुरोध गर्दछु ।

नोट: Final Bill पेश भएको ५६ दिन भित्र Engineer ले Final Payment Certificate जारी गर्नुपर्नेछ (FIDIC Clause 14.13) ।
...
// ==========================================
// DLP Completion निबेदन (त्रुटि दायित्व अवधि सम्पन्न)
// ==========================================
export function dlpCompletionNibedanTemplate(profile: CompanyProfile | null, bid?: Partial<BidData>): string {
  const co = profile?.companyName || '[कम्पनीको नाम]';
  const addr = profile?.address || '[ठेगाना]';
  const rep = profile?.authorizedRepresentative || '[अधिकृत प्रतिनिधि]';
  const desig = shortDesignation(profile?.designation || '');
...
विषय: त्रुटि दायित्व अवधि (Defects Liability Period) सम्पन्न प्रमाणपत्र जारी गरिदिन निवेदन ।

सन्दर्भ:
  ठेक्का नं.: ${contract}
  IFB नं.: ${ifb}
  आयोजना: ${proj}
  Substantial Completion मिति: [___________]
  DLP अवधि: [___] महिना
  DLP समाप्ति मिति: [___________]

महोदय,

उपरोक्त सन्दर्भित ठेक्काको त्रुटि दायित्व अवधि (Defects Liability Period / Defects Notification Period) मिति [___________] मा समाप्त भइसकेको हुँदा Performance Certificate / DLP Completion Certificate जारी गरिदिनु हुन यो निवेदन पेश गर्दछु ।

═══════════════════════════════════════════════════
         DLP अवधिको कार्य विवरण
═══════════════════════════════════════════════════

क्र.सं. │ विवरण                              │ स्थिति
────────┼─────────────────────────────────────┼──────────────
  १    │ Snag List Items सम्पन्न             │ ✅ सम्पूर्ण
  २    │ Engineer को Defect Notice मर्मत     │ ✅ सम्पन्न
  ३    │ Outstanding Works पूरा              │ ✅ सम्पन्न
  ४    │ Site सफाई र Restoration             │ ✅ सम्पन्न
  ५    │ As-Built Drawing बुझाएको            │ ✅ सम्पन्न
  ६    │ O&M Manual बुझाएको                  │ ✅ सम्पन्न
────────┴─────────────────────────────────────┴──────────────

═══════════════════════════════════════════════════
        DLP मा सूचित त्रुटि र मर्मत विवरण
═══════════════════════════════════════════════════

क्र.सं. │ त्रुटिको विवरण        │ सूचना मिति  │ मर्मत मिति  │ स्थिति
────────┼───────────────────────┼─────────────┼─────────────┼────────
  १    │ [________________]    │ [________]  │ [________]  │ सम्पन्न
  २    │ [________________]    │ [________]  │ [________]  │ सम्पन्न
  ३    │ [________________]    │ [________]  │ [________]  │ सम्पन्न
────────┴───────────────────────┴─────────────┴─────────────┴────────
(यदि कुनै त्रुटि सूचित नभएको भए "DLP अवधिमा कुनै त्रुटि सूचित भएको छैन" लेख्नुहोस्)

═══════════════════════════════════════════════════
        DLP पछि फिर्ता हुने रकम
═══════════════════════════════════════════════════

विवरण                              │ रकम (रु.)
────────────────────────────────────┼──────────────
Retention Money बाँकी (५०%)        │ [___________]
Performance Security फिर्ता        │ [___________]
────────────────────────────────────┴──────────────

संलग्न कागजातहरू:
  १. DLP Inspection Report (Engineer सँग संयुक्त)
  २. Snag List Clearance Certificate
  ३. Defect Rectification Photographs
  ४. As-Built Drawings (Final)
  ५. Operation & Maintenance Manual
  ६. Final Measurement (DLP कार्य सहित)
  ७. No Claim Certificate

अतः FIDIC Clause 11.9 तथा सार्वजनिक खरिद ऐन, २०६३ बमोजिम Performance Certificate जारी गरी Retention Money तथा Performance Security फिर्ता गरिदिनु हुन विनम्र अनुरोध गर्दछु ।

नोट: DLP समाप्ति पश्चात् २८ दिन भित्र Performance Certificate जारी गर्नुपर्नेछ (FIDIC Clause 11.9) ।
...
// ==========================================
// Insurance Claim निबेदन (बीमा दाबी)
// ==========================================
export function insuranceClaimNibedanTemplate(profile: CompanyProfile | null, bid?: Partial<BidData>): string {
  const co = profile?.companyName || '[कम्पनीको नाम]';
  const addr = profile?.address || '[ठेगाना]';
  const rep = profile?.authorizedRepresentative || '[अधिकृत प्रतिनिधि]';
  const desig = shortDesignation(profile?.designation || '');
  ...
  return `श्रीमान् [बीमा कम्पनीको नाम]
[बीमा कम्पनीको ठेगाना]

प्रतिलिपि: ${employer}

विषय: निर्माण कार्य सम्बन्धी बीमा दाबी (Insurance Claim) ।

सन्दर्भ:
  ठेक्का नं.: ${contract}
  आयोजना: ${proj}
  बीमालेख नं. (Policy No.): [___________]
  बीमा प्रकार: [CAR / Third Party Liability / Workmen's Compensation]
  घटना मिति: [___________]
  दाबी सूचना मिति: ${formatDate()}

महोदय,

उपरोक्त बीमालेख अन्तर्गत भएको घटनाको जानकारी गराउँदै बीमा दाबी प्रस्तुत गर्दछु ।
...
विवरण                              │ जानकारी
────────────────────────────────────┼──────────────────
घटनाको मिति र समय                  │ [___________]
घटना स्थल                          │ Ch. [___] - [___]
घटनाको प्रकार                      │ [बाढी/पहिरो/आगलागी/
                                    │  दुर्घटना/चोरी/अन्य]
मौसम अवस्था                        │ [___________]
प्रत्यक्षदर्शी                      │ [___________]
────────────────────────────────────┴──────────────────

═══════════════════════════════════════════════════
            क्षतिको विवरण (Damage Assessment)
═══════════════════════════════════════════════════

क्र.सं. │ क्षति भएको सम्पत्ति / कार्य  │ अनुमानित क्षति (रु.)
────────┼──────────────────────────────┼────────────────────
  १    │ [________________________]   │ [___________]
  २    │ [________________________]   │ [___________]
  ३    │ [________________________]   │ [___________]
  ४    │ [________________________]   │ [___________]
  ५    │ [________________________]   │ [___________]
────────┼──────────────────────────────┼────────────────────
       │ कुल अनुमानित क्षति            │ [___________]
       │ Deductible / Excess          │ [___________]
       │ दाबी रकम                     │ [___________]
────────┴──────────────────────────────┴────────────────────

═══════════════════════════════════════════════════
      तत्काल गरिएको कार्य (Immediate Actions)
═══════════════════════════════════════════════════

  १. क्षति न्यूनीकरण कार्य (Mitigation Measures): [___________]
  २. सुरक्षा व्यवस्था: [___________]
  ३. प्रहरी प्रतिवेदन (यदि लागू): [___________]
  ४. Engineer लाई सूचना: मिति [___________]

संलग्न कागजातहरू:
  १. बीमालेखको प्रतिलिपि (Insurance Policy Copy)
  २. घटना प्रतिवेदन (Incident Report)
  ३. फोटोग्राफ / भिडियो (घटना स्थलको)
  ४. प्रहरी प्रतिवेदन (FIR) — यदि लागू
  ५. मौसम विभागको प्रमाणपत्र — यदि लागू
  ६. क्षतिको विस्तृत आकलन (Damage Assessment Report)
  ७. मर्मत / पुनर्निर्माण लागत अनुमान
  ८. Engineer को Site Visit Report
  ९. प्रत्यक्षदर्शीको बयान (Witness Statement)
  १०. Medical Report — यदि व्यक्तिगत क्षति

अतः बीमालेखको शर्त बमोजिम उपरोक्त दाबी प्रशोधन गरी क्षतिपूर्ति रकम भुक्तानी गरिदिनु हुन विनम्र अनुरोध गर्दछु ।

नोट:
  - घटना भएको ७ दिन भित्र बीमा कम्पनीलाई सूचना दिनुपर्छ
  - बीमा सर्भेयर को निरीक्षण अघि क्षतिग्रस्त सामग्री नहटाउनुहोस्
  - FIDIC Clause 18 अनुसार ठेकेदारले CAR Insurance कायम राख्नुपर्छ
